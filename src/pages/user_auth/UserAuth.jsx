      ...
      <div className={styles.frame}>
        <div className={styles.signup_container}>
          <form className={styles.signup_input}>
            ...
            <label className={styles.label}>
              User Name<br/>
              <input className={styles.input} name='username' type="text" value={username} onChange={onChange}/>
            </label>
            <label className={styles.label}>
              Password<br/>
        ...
        <div className={styles.login_container}>
          <form className={styles.login_input}>
            ...
            <button className={styles.submit_button} type='submit'>{toggleLogin===null || toggleLogin===true? 'Login' : 'Signup'}</button>
          </form>
